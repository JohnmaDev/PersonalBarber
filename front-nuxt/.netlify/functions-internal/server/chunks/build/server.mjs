import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, hasInjectionContext, inject, computed, toValue, onServerPrefetch, reactive, ref, Suspense, Fragment, useSSRContext, createApp, shallowReactive, mergeProps, onErrorCaptured, unref, createVNode, resolveDynamicComponent, effectScope, nextTick, toRef, defineAsyncComponent, getCurrentScope, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { p as parseURL, k as encodePath, l as decodePath, m as hasProtocol, n as isScriptProtocol, h as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch, q as hash, c as createError$1, r as executeAsync, t as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "tienda-producto-slug",
    path: "/tienda/producto/:slug()",
    component: () => import('./_slug_-ByemM2Ey.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-DwywJkA6.mjs')
  },
  {
    name: "agendar",
    path: "/agendar",
    component: () => import('./agendar-2NsEBEPe.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-Buevg71-.mjs')
  },
  {
    name: "tienda",
    path: "/tienda",
    component: () => import('./index-K5ty5gM6.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DWXAJPM5.mjs')
  }
];
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ id: "app-container" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_NuxtPage, { keepalive: { include: ["tienda"] } }, null, _parent));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-UGgAeFmD.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D1_2kXI3.mjs'));
...
export { __nuxt_component_1 as _, useRouter as a, useFetch as b, useNuxtApp as c, useRuntimeConfig as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, useRoute as u };
