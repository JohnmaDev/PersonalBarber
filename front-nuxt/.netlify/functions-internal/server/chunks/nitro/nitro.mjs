...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "a4eb8c0c-2767-4922-ae04-e8811a1c1779",
...
const _CvGxHUA8mIb3VVdojaMlOnbGcwjVavKalu_gzD1O86M = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _CvGxHUA8mIb3VVdojaMlOnbGcwjVavKalu_gzD1O86M
];
...
const _HQ4pqq = eventHandler(async (e) => {
...
const _FPUbNf = defineEventHandler(async (e) => {
...
const _Ye3NyK = defineEventHandler(sitemapXmlEventHandler);

const _lazy_fNVJBs = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_fNVJBs, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _HQ4pqq, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _FPUbNf, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _Ye3NyK, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_fNVJBs, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, getResponseStatus as a, getQuery as b, createError$1 as c, defineRenderHandler as d, destr as e, getRouteRules as f, getResponseStatusText as g, joinURL as h, useNitroApp as i, joinRelativeURL as j, encodePath as k, decodePath as l, hasProtocol as m, isScriptProtocol as n, getContext as o, parseURL as p, hash$1 as q, executeAsync as r, sanitizeStatusCode as s, defu as t, useRuntimeConfig as u, parseQuery as v, withQuery as w, withTrailingSlash as x, withoutTrailingSlash as y, handler as z };
