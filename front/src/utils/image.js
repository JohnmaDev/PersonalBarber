 ...
 * Inyecta f_auto (formato automático: WebP/AVIF según browser),
 * q_auto (calidad adaptativa) y opcionalmente w_{width} con c_limit
 * para servir imágenes escaladas según el contexto de uso.
 *
 * @param {string} url   - URL de Cloudinary
 * @param {number} width - Ancho máximo en píxeles (0 = sin resize)
 ...
 *     1200 → hero/headers
 */
export function optimizeImage(url, width = 0) {
