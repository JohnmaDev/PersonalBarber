  ...
  <div>
    <div class="flex items-center justify-between mb-6 text-center sm:text-left flex-col sm:flex-row gap-4">
      ...
      <div class="flex gap-2">
        <button @click="cargarCortes" :disabled="cargando" class="flex items-center justify-center w-10 h-10 bg-zinc-900 border border-zinc-800 rounded-xl text-zinc-400 hover:text-white transition-all group px-3">
          <i :class="[
            'fas', 
